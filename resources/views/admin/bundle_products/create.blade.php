        ...
        <div class="container mx-auto max-w-4xl">
            ...
            <form action="{{ route('admin.bundle-products.store') }}" method="POST" class="space-y-8">
                ...
                <div class="card-custom">
                    ...
                    <div class="card-custom-body">
                        <p class="text-sm text-gray-600 mb-4">Đây là danh sách các sản phẩm được gợi ý mua kèm với giá ưu
                            đãi.</p>
                            ...
                            <template x-for="(product, index) in suggestedProducts" :key="product.id">
                                <div class="p-4 border rounded-lg" x-data="{ open: true, discountType: product.discount_type }">
                                    <div class="flex items-center justify-between cursor-pointer" @click="open = !open">
                                        ...
                                        <div class="flex items-center gap-4">
                                            <button type="button" class="text-red-500 hover:text-red-700"
                                                @click="removeSuggestedProduct(product.id)"><i
                                    ...
                                    <div x-show="open" class="mt-4 pt-4 border-t grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-1">Loại giảm
                                                giá</label>
                                            <select class="form-select"
                                                :name="'suggested_products[' + index + '][discount_type]'"
                                                x-model="discountType">
                                                <option value="fixed_price"
                                                    :selected="product.discount_type === 'fixed_price'">Giá cố định
                                                </option>
                                                <option value="percentage_discount"
                                                    :selected="product.discount_type === 'percentage_discount'">Giảm theo %
                                                </option>
                                            </select>

                                        </div>
                                        <div class="input-group">
                                            <label class="block text-sm font-medium text-gray-700 mb-1">Giá trị
                                                giảm</label>
                                            <input type="number" class="form-input"
                                                :name="'suggested_products[' + index + '][discount_value]'"
                                            ...
                                            <span class="input-unit"
                                                x-text="discountType === 'fixed_price' ? 'VNĐ' : '%'"></span>
                                        ...
                                        <div class="md:col-span-2">
                                            <label class="flex items-center">
                                                <input type="checkbox"
                                                    ...
                                                    :name="'suggested_products[' + index + '][is_preselected]'"
                                                    :checked="product.is_preselected" value="1">
                ...
                <div class="flex justify-end gap-4">
                    ...
                    <button type="submit" class="btn btn-primary">Lưu Deal</button>
                </div>
            </form>
        </div>
    ...
    <script>
        function dealManager() {
            return {
                ...
                mainProducts: [],
                suggestedProducts: [],
                allProducts: @json($productVariants), // Dữ liệu từ controller
                selectedProducts: [],
