                ...
                <table class="min-w-full text-sm text-left text-gray-700">
                    <thead class="bg-indigo-50">
                        <tr>
                            ...
                            <th class="px-8 py-4 w-40 font-semibold tracking-wide text-indigo-700 text-center">Số bình luận
                            </th>
                            <th class="px-8 py-4 w-48 font-semibold tracking-wide text-indigo-700 text-center">Hành động
                            </th>
                        </tr>
                    </thead>
                    <tbody>
