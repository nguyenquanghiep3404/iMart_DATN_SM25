            ...
            <table class="w-full text-left table-auto border-collapse">
                <tbody class="text-gray-800">
                    ...
                    <tr class="border-b">
                        ...
                        <td class="py-4 px-6">
                            <form action="{{ route('admin.comments.updateStatus', $comment) }}" method="POST" class="flex items-center space-x-3">
                                @csrf
                                {{-- @method('PATCH') --}}

                                <select name="status" class="border-gray-300 rounded-lg px-4 py-2 shadow-sm focus:ring-blue-500 focus:border-blue-500">
