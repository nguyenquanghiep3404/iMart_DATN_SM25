        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between">
            ...
            <div class="mt-4 sm:mt-0 flex flex-wrap gap-2">
                ...
                @if(in_array($purchaseOrder->status, ['pending', 'waiting_for_scan']))
                    <a href="{{ route('admin.purchase-orders.receiving.index', ['po_id' => $purchaseOrder->id]) }}" class="flex items-center bg-green-600 text-white font-bold py-2 px-4 rounded-lg shadow-md hover:bg-green-700 transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
