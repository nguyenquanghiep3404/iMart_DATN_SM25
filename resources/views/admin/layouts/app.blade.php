...
<body>
    <div class="tp-main-wrapper bg-slate-100 min-h-screen" x-data="{ sideMenu: false }">
        ...
        <div class="fixed top-0 left-0 w-full h-full z-40 bg-black/70 transition-all duration-300 print:hidden"
            :class="sideMenu ? 'visible opacity-1' : 'invisible opacity-0'" x-on:click="sideMenu = false"></div>
