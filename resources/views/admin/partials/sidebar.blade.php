        ...
        {{ $isBannersActive ? 'bg-indigo-50 text-indigo-600 font-semibold' : 'text-gray-700 hover:text-indigo-600 hover:bg-indigo-50/50 font-medium' }}">
                ...
                <li>
                    ...
                    <ul x-show="openNav === 9" class="pl-8 pr-2 py-1 space-y-1 mt-1">
                        ...
                        <li>
                            <a href="{{ route('admin.categories_post.index') }}" {{-- Giả sử route --}}
                                class="block w-full py-1.5
                                px-3 text-sm rounded-md
            ...
            {{ $isHomepagesActive ? 'bg-indigo-50 text-indigo-600 font-semibold' : 'text-gray-700 hover:text-indigo-600 hover:bg-indigo-50/50 font-medium' }}">
                        <span
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                ...
                                <path
                                    d="M3 9.857L12 3l9 6.857v9.286A1.857 1.857 0 0 1 19.143 21H4.857A1.857 1.857 0 0 1 3 19.143V9.857Zm9-4.714L5.571 10.5v8.643h12.858V10.5L12 5.143Zm-2.571 7.786h5.143v5.143H9.429v-5.143Z" />
                            </svg>
                        </span>
                        Quản lý trang chủ
                    </a>
                ...
                <li>
                    @php $isSalesActive = request()->routeIs('admin.abandoned-carts.*'); @endphp <a href="{{ route('admin.abandoned-carts.index') }}"
                        ...
                        <span
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                fill="currentColor" viewBox="0 0 24 24">
                                <path d="M7 4h-2l-1 2h2l3.6 7.59-1.35 2.45C7.16 17.37 7 17.91 7 18.5
                                7 19.88 8.12 21 9.5 21s2.5-1.12 2.5-2.5c0-.59-.16-1.13-.44-1.59l.94-1.71h4.59c.75
                                0 1.41-.41 1.75-1.03L23 6H6.21l-.94-2H1v2h2l3.6 7.59-1.35 2.45C4.16 17.37
                                4 17.91 4 18.5 4 19.88 5.12 21 6.5 21s2.5-1.12 2.5-2.5c0-.59-.16-1.13-.44-1.59l.94-1.71h4.59l1.45
                                2.59c.34.62 1 1.03 1.75 1.03H20v-2h-1.42l-1.45-2.59L7 4z" />
                            </svg>
                        </span>
