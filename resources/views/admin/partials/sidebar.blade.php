@php
    ...
    $navSections = [
        ...
        'marketing_campaigns' => ['admin.marketing_campaigns.'],
    ];
            ...
            <ul class="space-y-1">
                ...
                <li>
                    ...
                    <ul x-show="openNav === 'marketing'" class="pl-8 pr-2 py-1 space-y-1 mt-1">
                        ...
                        <li><a href="{{ route('admin.banners.index') }}"
                                ...
                                lý Banner</a></li>
                        <li><a href="{{ route('admin.marketing_campaigns.index') }}"
                                class="block w-full py-1.5 px-3 text-sm rounded-md {{ request()->routeIs('admin.banners.*') ? 'bg-indigo-100 text-indigo-700 font-medium' : 'text-slate-600 hover:text-indigo-600 hover:bg-indigo-50/50' }}">Chiến
                                dịch marketing</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul x-show="openNav === 'customers'" class="pl-8 pr-2 py-1 space-y-1 mt-1">
                        ...
                        <li><a href="{{ route('admin.customer-groups.index') }}"
                                class="block w-full py-1.5 px-3 text-sm rounded-md {{ request()->routeIs('admin.customer-groups.*') ? 'bg-indigo-100 text-indigo-700 font-medium' : 'text-slate-600 hover:text-indigo-600 hover:bg-indigo-50/50' }}">Quản
                                lý khách hàng</a></li>
                    </ul>
                </li>
                    ...
                    <a href="{{ route('admin.suppliers.index') }}"
                        ...
                        <span
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18"
                                height="18" fill="currentColor">
                                <path
                                    d="M20,8H4V4H20ZM4,12H9v4H4Zm11,0h5v4H15ZM3,2H21a1,1,0,0,1,1,1V21a1,1,0,0,1-1,1H3a1,1,0,0,1-1-1V3A1,1,0,0,1,3,2Z" />
                            </svg>
                        </span>
                        Nhà cung cấp
                    </a>
                ...
                <li>
                    @php $isSuppliersActive = request()->routeIs('admin.registers.*'); @endphp
                        ...
                        <span
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-600" fill="none"
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9.75 17h4.5m-9.75 2.25h15a1.5 1.5 0 001.5-1.5V6.75a1.5 1.5 0 00-1.5-1.5h-15a1.5 1.5 0 00-1.5 1.5v11.25a1.5 1.5 0 001.5 1.5z" />
                            </svg>
                        </span>
                        Quản lý máy POS
                    </a>
