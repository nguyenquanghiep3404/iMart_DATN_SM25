    ...
    <div>
        ...
        <div class="flex h-[65px] items-center justify-center border-b border-slate-200 px-3 lg:px-6 py-4">
            <a href="{{ route('admin.dashboard') }}">
                {{-- Full Logo --}}
                <img class="hidden lg:block" src="{{ asset('assets/users/logo/logo-full.svg') }}" alt="Full Logo" style="width: 150px;">
                {{-- Icon Logo --}}
                <img class="block lg:hidden" src="{{ asset('assets/users/logo/logo-icon.svg') }}" alt="Icon Logo" style="width: 40px;">
            </a>
        </div>
        {{-- END HEADER --}}
                ...
                <ul class="space-y-1 mt-2">
                    ...
                    <li>
                         <button @click="openNav !== 'settings' ? openNav = 'settings' : openNav = null"
                            :class="openNav === 'settings' ? 'bg-indigo-50 text-indigo-600 font-semibold' : 'text-slate-700 hover:text-indigo-600 hover:bg-indigo-50/50 font-medium'"
                            class="group w-full flex items-center px-4 py-2.5 text-base rounded-md transition-all">
                            <span class="mr-3 text-lg {{ $activeParentNav === 'settings' ? 'text-indigo-600' : 'text-slate-500 group-hover:text-indigo-500' }}">
                            ...
                            Cài đặt trang web
                            <span class="ml-auto transition-transform" :class="openNav === 'settings' ? 'rotate-90' : ''">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M15.4,9.88,10.81,5.29a1,1,0,0,0-1.41,0,1,1,0,0,0,0,1.42L14,11.29a1,1,0,0,1,0,1.42L9.4,17.29a1,1,0,0,0,1.41,1.42l4.59-4.59A3,3,0,0,0,15.4,9.88Z" /></svg>
                            </span>
                        </button>
                        <ul x-show="openNav === 'settings'" class="pl-8 pr-2 py-1 space-y-1 mt-1">
                            <li><a href="#" class="block w-full py-1.5 px-3 text-sm rounded-md text-slate-600 hover:text-indigo-600 hover:bg-indigo-50/50">Cài đặt chung</a></li>
                            <li><a href="#" class="block w-full py-1.5 px-3 text-sm rounded-md text-slate-600 hover:text-indigo-600 hover:bg-indigo-50/50">Thanh toán & Vận chuyển</a></li>
                        </ul>
                    </li>
                    {{-- Page Management --}}
                    <li>
                        <a href="#"
                            class="group flex items-center px-4 py-2.5 text-base rounded-md transition-all text-slate-700 hover:text-indigo-600 hover:bg-indigo-50/50 font-medium">
                            <span class="mr-3 text-lg text-slate-500 group-hover:text-indigo-500">
