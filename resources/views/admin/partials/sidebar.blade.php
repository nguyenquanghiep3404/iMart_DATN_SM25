@php
    ...
    if (str_starts_with($currentRouteName, 'admin.admin.dashboard')) {
        $activeParentNav = 0;
    } elseif (str_starts_with($currentRouteName, 'admin.products.') || str_starts_with($currentRouteName, 'admin.attributes.')) {
...
<aside class="w-[300px] lg:w-[250px] xl:w-[300px] border-r border-slate-200 overflow-y-auto sidebar-scrollbar fixed left-0 top-0 h-full bg-white z-40 transition-transform duration-300 print:hidden"
            ...
            <ul class="space-y-1">
                ...
                <li>
                    ...
                    <button @click="openNav !== 1 ? openNav = 1 : openNav = null"
                            :class="openNav === 1 ? 'bg-indigo-50 text-indigo-600 font-semibold' : 'text-gray-700 hover:text-indigo-600 hover:bg-indigo-50/50 font-medium'"
 ...
 Thêm thuộc tính mới
                ...
                <li>
                    ...
                    <button @click="openNav !== 2 ? openNav = 2 : openNav = null"
                            :class="openNav === 2 ? 'bg-indigo-50 text-indigo-600 font-semibold' : 'text-gray-700 hover:text-indigo-600 hover:bg-indigo-50/50 font-medium'"
                            class="group w-full flex items-center px-4 py-2.5 text-base rounded-md transition-all duration-200 ease-in-out">
                        <span class="mr-3 text-lg {{ $isCategoriesActive ? 'text-indigo-600' : 'text-gray-500 group-hover:text-indigo-500' }}">
                           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M22.713,4.077A2.993,2.993,0,0,0,20.41,3H4.242L4.2,2.649A3,3,0,0,0,1.222,0H1A1,1,0,0,0,1,2h.222a1,1,0,0,1,.993.883l1.376,11.7A5,5,0,0,0,8.557,19H19a1,1,0,0,0,0-2H8.557a3,3,0,0,1-2.82-2h11.92a5,5,0,0,0,4.921-4.113l.785-4.354A2.994,2.994,0,0,0,22.713,4.077ZM21.4,6.178l-.786,4.354A3,3,0,0,1,17.657,13H5.419L4.478,5H20.41A1,1,0,0,1,21.4,6.178Z" /><circle cx="7" cy="22" r="2" /><circle cx="17" cy="22" r="2" /></svg>
                        </span>
                        Danh mục sản phẩm
                        <span class="ml-auto transition-transform duration-200 ease-in-out" :class="openNav === 2 ? 'rotate-90' : ''">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M15.4,9.88,10.81,5.29a1,1,0,0,0-1.41,0,1,1,0,0,0,0,1.42L14,11.29a1,1,0,0,1,0,1.42L9.4,17.29a1,1,0,0,0,1.41,1.42l4.59-4.59A3,3,0,0,0,15.4,9.88Z" /></svg>
                        </span>
                    </button>
                ...
                <li>
                    ...
                    <button @click="openNav !== 3 ? openNav = 3 : openNav = null"
                            :class="openNav === 3 ? 'bg-indigo-50 text-indigo-600 font-semibold' : 'text-gray-700 hover:text-indigo-600 hover:bg-indigo-50/50 font-medium'"
                            class="group w-full flex items-center px-4 py-2.5 text-base rounded-md transition-all duration-200 ease-in-out">
                        ...
                        Đơn hàng
                        <span class="ml-auto transition-transform duration-200 ease-in-out" :class="openNav === 3 ? 'rotate-90' : ''">
                             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M15.4,9.88,10.81,5.29a1,1,0,0,0-1.41,0,1,1,0,0,0,0,1.42L14,11.29a1,1,0,0,1,0,1.42L9.4,17.29a1,1,0,0,0,1.41,1.42l4.59-4.59A3,3,0,0,0,15.4,9.88Z" /></svg>
                        </span>
                    </button>
                    <ul x-show="openNav === 3" class="pl-8 pr-2 py-1 space-y-1 mt-1">
                        <li>
                            <a href="{{-- {{ route('admin.orders.index') }}" {{-- Giả sử route --}}
                               class="block w-full py-1.5 px-3 text-sm rounded-md {{ request()->routeIs('admin.orders.index') ? 'bg-indigo-100 text-indigo-700 font-medium' : 'text-gray-600 hover:text-indigo-600 hover:bg-indigo-50/50' }}">
                                Danh sách đơn hàng
                            </a>
                        </li>
                    </ul>
                ...
                <li>
                    ...
                    <button @click="openNav !== 4 ? openNav = 4 : openNav = null"
                            :class="openNav === 4 ? 'bg-indigo-50 text-indigo-600 font-semibold' : 'text-gray-700 hover:text-indigo-600 hover:bg-indigo-50/50 font-medium'"
                            class="group w-full flex items-center px-4 py-2.5 text-base rounded-md transition-all duration-200 ease-in-out">
                        <span class="mr-3 text-lg {{ $isUsersActive ? 'text-indigo-600' : 'text-gray-500 group-hover:text-indigo-500' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M12,12A6,6,0,1,0,6,6,6.006,6.006,0,0,0,12,12ZM12,2A4,4,0,1,1,8,6,4,4,0,0,1,12,2Z"/><path d="M12,14a9.01,9.01,0,0,0-9,9,1,1,0,0,0,1,1H20a1,1,0,0,0,1-1A9.01,9.01,0,0,0,12,14ZM4.136,22A7.006,7.006,0,0,1,11,16H13a7.006,7.006,0,0,1,6.864,6Z"/></svg>
                        </span>
                        Quản lý người dùng
                ...
                <li>
                    ...
                    <a href="{{-- route('admin.reviews.index') }}" {{-- Giả sử route --}}
                       class="group flex items-center px-4 py-2.5 text-base rounded-md transition-all duration-200 ease-in-out
                        ...
                        <span class="mr-3 text-lg {{ $isReviewsActive ? 'text-indigo-600' : 'text-gray-500 group-hover:text-indigo-500' }}">
                           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M22,9.67A1,1,0,0,0,21.14,9l-5.69-.83L12.9,3a1,1,0,0,0-1.8,0L8.55,8.16,2.86,9a1,1,0,0,0-.54,1.75l4.13,4-1,5.68A1,1,0,0,0,6.9,22.25l5.1-2.68,5.1,2.68a1,1,0,0,0,1.45-1.05l-1-5.68,4.13-4A1,1,0,0,0,22,9.67ZM12,18.27,8.24,20.3,9.23,16,6.06,13.18l4.32-.63L12,8.88l1.62,3.67,4.32.63L14.77,16l1,4.3Z"/></svg>
                        </span>
                        Quản lý đánh giá
                    </a>
                </li>
                ...
                <li>
                    ...
                    <a href="{{-- {{ route('admin.coupons.index') }}" {{-- Giả sử route --}}
                       class="group flex items-center px-4 py-2.5 text-base rounded-md transition-all duration-200 ease-in-out
                        ...
                        <span class="mr-3 text-lg {{ $isCouponsActive ? 'text-indigo-600' : 'text-gray-500 group-hover:text-indigo-500' }}">
                           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M19.6,4.4a8.21,8.21,0,0,0-11.41,0l-4.24,4.24a8.21,8.21,0,0,0,11.41,11.41l4.24-4.24a8.21,8.21,0,0,0,0-11.41ZM12,18.49a6.21,6.21,0,0,1-4.4-1.83L3.35,12.41a6.21,6.21,0,0,1,8.79-8.79l.17.17,4.24,4.24-4.24,4.24ZM18.17,9.83,14,5.66l1.41-1.41,4.24,4.24ZM9.83,18.17,5.66,14l-1.41,1.41,4.24,4.24ZM14.12,14A3.1,3.1,0,1,0,9.88,9.88,3.1,3.1,0,0,0,14.12,14Z"/></svg>
                        </span>
                        Quản lý mã giảm giá
                    </a>
                </li>
                ...
                <li>
                    ...
                    <a href="{{-- {{ route('admin.roles.index') }}" {{-- Giả sử route --}}
                       class="group flex items-center px-4 py-2.5 text-base rounded-md transition-all duration-200 ease-in-out
                        ...
                        <span class="mr-3 text-lg {{ $isRolesActive ? 'text-indigo-600' : 'text-gray-500 group-hover:text-indigo-500' }}">
                           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M12,12.75a3,3,0,1,0-3-3A3,3,0,0,0,12,12.75ZM12,8.25a1.5,1.5,0,1,1-1.5,1.5A1.5,1.5,0,0,1,12,8.25Z"/><path d="M21.5,9.75a1.5,1.5,0,1,1-1.5,1.5A1.5,1.5,0,0,1,21.5,9.75Z"/><path d="M21.5,2.25a1.5,1.5,0,1,1-1.5,1.5A1.5,1.5,0,0,1,21.5,2.25Z"/><path d="M21.5,17.25a1.5,1.5,0,1,1-1.5,1.5A1.5,1.5,0,0,1,21.5,17.25Z"/><path d="M12,21.75a3,3,0,1,0-3-3A3,3,0,0,0,12,21.75ZM12,17.25a1.5,1.5,0,1,1-1.5,1.5A1.5,1.5,0,0,1,12,17.25Z"/><path d="M12,5.25a3,3,0,1,0-3-3A3,3,0,0,0,12,5.25ZM12,.75A1.5,1.5,0,1,1,10.5,2.25,1.5,1.5,0,0,1,12,.75Z"/><path d="M4,11.25a3,3,0,1,0-3-3A3,3,0,0,0,4,11.25ZM4,6.75A1.5,1.5,0,1,1,2.5,8.25,1.5,1.5,0,0,1,4,6.75Z"/><path d="M18.27,15.64a4.48,4.48,0,0,0-2.3-2.3,4.5,4.5,0,0,0-5.94,5.94,4.48,4.48,0,0,0,2.3,2.3A4.5,4.5,0,0,0,18.27,15.64Zm-6.73,3.82a3,3,0,0,1,3.83-3.83,3.08,3.08,0,0,1,.89.13,3,3,0,0,1,1.38,4.49,3.08,3.08,0,0,1-.13.89A3,3,0,0,1,11.54,19.46Z"/><path d="M5.73,8.36a4.5,4.5,0,0,0,5.94-5.94A4.48,4.48,0,0,0,9.37.12a4.5,4.5,0,0,0-5.94,5.94A4.48,4.48,0,0,0,5.73,8.36ZM9.56,2.29a3,3,0,1,1-4.5,1.38,3,3,0,0,1,1.37-4.49A3,3,0,0,1,9.56,2.29Z"/></svg>
                        </span>
                        Quản lý phân quyền
                    </a>
                </li>
                ...
                <li>
                    ...
                    <a href="{{-- {{ route('admin.banners.index') }}"  {{-- Giả sử route --}}
                       class="group flex items-center px-4 py-2.5 text-base rounded-md transition-all duration-200 ease-in-out
                        ...
                        <span class="mr-3 text-lg {{ $isBannersActive ? 'text-indigo-600' : 'text-gray-500 group-hover:text-indigo-500' }}">
                           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M21,2H3A1,1,0,0,0,2,3V21a1,1,0,0,0,1,1H21a1,1,0,0,0,1-1V3A1,1,0,0,0,21,2ZM4,4H20V16H4ZM4,20V18H20v2Z"/><path d="M12.5,11.5a1,1,0,1,0-1-1A.999.999,0,0,0,12.5,11.5Z"/><path d="M6,6H8V8H6Z"/></svg>
                        </span>
                        Quản lý banner
                    </a>
                </li>
                ...
                <li>
                    ...
                    <button @click="openNav !== 9 ? openNav = 9 : openNav = null"
                            :class="openNav === 9 ? 'bg-indigo-50 text-indigo-600 font-semibold' : 'text-gray-700 hover:text-indigo-600 hover:bg-indigo-50/50 font-medium'"
                            class="group w-full flex items-center px-4 py-2.5 text-base rounded-md transition-all duration-200 ease-in-out">
                        <span class="mr-3 text-lg {{ $isPostCategoriesActive ? 'text-indigo-600' : 'text-gray-500 group-hover:text-indigo-500' }}">
                        ...
                        <span class="ml-auto transition-transform duration-200 ease-in-out" :class="openNav === 9 ? 'rotate-90' : ''">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M15.4,9.88,10.81,5.29a1,1,0,0,0-1.41,0,1,1,0,0,0,0,1.42L14,11.29a1,1,0,0,1,0,1.42L9.4,17.29a1,1,0,0,0,1.41,1.42l4.59-4.59A3,3,0,0,0,15.4,9.88Z" /></svg>
                        </span>
                    </button>
                    <ul x-show="openNav === 9" class="pl-8 pr-2 py-1 space-y-1 mt-1">
                        <li>
                            <a href="{{--{{ route('admin.post-categories.index') }}" {{-- Giả sử route --}}
                               class="block w-full py-1.5 px-3 text-sm rounded-md {{ request()->routeIs('admin.post-categories.index') ? 'bg-indigo-100 text-indigo-700 font-medium' : 'text-gray-600 hover:text-indigo-600 hover:bg-indigo-50/50' }}">
                                Danh sách danh mục
                            </a>
                        </li>
                        <li>
                            <a href="{{-- {{ route('admin.post-categories.create') }}" {{-- Giả sử route --}}
                               class="block w-full py-1.5 px-3 text-sm rounded-md {{ request()->routeIs('admin.post-categories.create') ? 'bg-indigo-100 text-indigo-700 font-medium' : 'text-gray-600 hover:text-indigo-600 hover:bg-indigo-50/50' }}">
                                Thêm mới danh mục
                            </a>
                        </li>
                    </ul>
                ...
                <li>
                    ...
                    <a href="{{-- {{ route('admin.shippers.index') }}" {{-- Giả sử route --}}
                       class="group flex items-center px-4 py-2.5 text-base rounded-md transition-all duration-200 ease-in-out
                        ...
                        <span class="mr-3 text-lg {{ $isShippersActive ? 'text-indigo-600' : 'text-gray-500 group-hover:text-indigo-500' }}">
                           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M21.5,13a.5.5,0,0,0,0-.15L20.15,7.2A3.49,3.49,0,0,0,16.85,5H15V2.5a.5.5,0,0,0-1,0V5H10V2.5a.5.5,0,0,0-1,0V5H3.5a.5.5,0,0,0-.5.5v11a.5.5,0,0,0,.5.5h1a.5.5,0,0,0,0-1H4V14h7v2.5a.5.5,0,0,0,1,0V14h9v2.5a.5.5,0,0,0,.5.5h1a.5.5,0,0,0,.5-.5V13.5A.5.5,0,0,0,21.5,13ZM9,12H4V7.5a.5.5,0,0,0-.5-.5H3.12l1-4.2A2.5,2.5,0,0,1,6.5,1H17.5a2.5,2.5,0,0,1,2.38,1.8l1,4.2H15V12H9ZM7,9.5A1.5,1.5,0,1,1,5.5,8,1.5,1.5,0,0,1,7,9.5Zm12,0a1.5,1.5,0,1,1-1.5-1.5A1.5,1.5,0,0,1,19,9.5Z"/></svg>
                        </span>
