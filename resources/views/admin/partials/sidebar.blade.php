...
$navigation = [
    ...
    [
        ...
        'type' => 'dropdown',
        'id' => 'sales',
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M21.08,7a2,2,0,0,0-1.7-1H6.58L6,3.74A1,1,0,0,0,5,3H3A1,1,0,0,0,3,5H4.24L7,15.26A1,1,0,0,0,8,16H18a1,1,0,0,0,.93-.66L21.23,9.34A2,2,0,0,0,21.08,7Zm-2.39,7H8.74L7.22,7H19.38Z" /><circle cx="8.5" cy="19.5" r="1.5" /><circle cx="17.5" cy="19.5" r="1.5" /></svg>',
        'children' => [
            ...
            ['label' => 'Giỏ hàng bỏ lỡ', 'route' => 'admin.abandoned-carts.index', 'active_check' => ['admin.abandoned-carts.']],
        ]
    ],
    ...
    [
        ...
        'type' => 'dropdown',
        'id' => 'pos',
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M6 3h12a1 1 0 011 1v3H5V4a1 1 0 011-1zm0 5h12v13a1 1 0 01-1 1H7a1 1 0 01-1-1V8zm2 3h2m4 0h2m-8 4h6" /></svg>',
        'children' => [
            ['label' => 'Máy POS', 'route' => 'admin.registers.index', 'active_check' => ['admin.registers.']],
            ['label' => 'Nhân viên bán hàng', 'route' => 'admin.sales-staff.index', 'active_check' => ['admin.sales-staff.']],
            ['label' => 'Địa điểm cửa hàng', 'route' => 'admin.store-locations.index', 'active_check' => ['admin.store-locations.']],
        ]
    ],
    ...
    [
        ...
        'type' => 'dropdown',
        'id' => 'marketing',
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M20.2,6.2a1,1,0,0,0-1.1.2L14.9,9.6A4.47,4.47,0,0,0,8,7.5,4.5,4.5,0,0,0,3.5,12,4.5,4.5,0,0,0,8,16.5a4.47,4.47,0,0,0,6.9-2.1l4.2,3.2a1,1,0,0,0,1.3-.2,1,1,0,0,0-.2-1.3L16,13.2a4.49,4.49,0,0,0-1-.7V10.1l5.4-4.1a1,1,0,0,0,.2-1.4A.87.87,0,0,0,20.2,6.2ZM8,14.5a2.5,2.5,0,1,1,2.5-2.5A2.5,2.5,0,0,1,8,14.5Z" /><path d="M8,13a1,1,0,0,0,1-1V8a1,1,0,0,0-2,0v4A1,1,0,0,0,8,13Z" /></svg>',
        'children' => [
            ['label' => 'Chiến dịch', 'route' => 'admin.marketing_campaigns.index', 'active_check' => ['admin.marketing_campaigns.']],
            ['label' => 'Mã giảm giá', 'route' => 'admin.coupons.index', 'active_check' => ['admin.coupons.']],
            ['label' => 'Flash Sales', 'route' => 'admin.flash-sales.index', 'active_check' => ['admin.flash-sales.']],
            ['label' => 'Quản lý Banner', 'route' => 'admin.banners.index', 'active_check' => ['admin.banners.']],
            ['label' => 'Quản lý Trang chủ', 'route' => 'admin.homepage.index', 'active_check' => ['admin.homepage.']],
        ]
    ],
    ...
    [
        ...
        'type' => 'dropdown',
        'id' => 'customers',
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M12,12A6,6,0,1,0,6,6,6.006,6.006,0,0,0,12,12Zm0-10a4,4,0,1,1-4,4A4,4,0,0,1,12,2Z" /><path d="M12,14a9.01,9.01,0,0,0-9,9,1,1,0,0,0,1,1H20a1,1,0,0,0,1-1A9.01,9.01,0,0,0,12,14Zm-7,8a7.012,7.012,0,0,1,14,0Z" /></svg>',
        'children' => [
            ['label' => 'Danh sách khách hàng', 'route' => 'admin.users.index', 'active_check' => ['admin.users.']],
            ['label' => 'Nhóm khách hàng', 'route' => 'admin.customer-groups.index', 'active_check' => ['admin.customer-groups.']],
            ['label' => 'Điểm thưởng', 'route' => 'admin.purchase-orders.loyalty.index', 'active_check' => ['admin.purchase-orders.loyalty.']],
        ]
    ],
    ...
    [
        ...
        'type' => 'dropdown',
        'id' => 'staff',
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M16,14a5,5,0,1,0-5-5A5,5,0,0,0,16,14Zm0-8a3,3,0,1,1-3,3A3,3,0,0,1,16,6Z" /><path d="M16,16a6.991,6.991,0,0,0-5.83,3H21.83A6.991,6.991,0,0,0,16,16Z" /><path d="M8,9a5,5,0,1,0-5,5A5,5,0,0,0,8,9ZM8,1a3,3,0,1,1-3,3A3,3,0,0,1,8,1Z" /><path d="M8,11a6.991,6.991,0,0,0-5.83,3H13.83A6.991,6.991,0,0,0,8,11Z" /></svg>',
        'children' => [
            ['label' => 'NV Giao hàng', 'route' => 'admin.shippers.index', 'active_check' => ['admin.shippers.']],
            ['label' => 'NV Nội dung', 'route' => 'admin.content-staffs.index', 'active_check' => ['admin.content-staffs.']],
            ['label' => 'NV Đơn hàng', 'route' => 'admin.order-manager.index', 'active_check' => ['admin.order-manager.']],
        ]
    ],
    ...
    [
        ...
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96zM14 13v4h-4v-4H7l5-5 5 5h-3z" /></svg>',
    ],
    ...
    [
        ...
        'type' => 'dropdown',
        'id' => 'settings',
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M19.43,12.94a1,1,0,0,0-1.15-.36l-1.09.36a8.31,8.31,0,0,0-1.25-1.25l.36-1.09a1,1,0,0,0-.36-1.15L14,7.57a1,1,0,0,0-1.21,0L11.06,9.43a1,1,0,0,0-.36,1.15l.36,1.09a8.31,8.31,0,0,0-1.25,1.25l-1.09-.36a1,1,0,0,0-1.15.36L5.57,14a1,1,0,0,0,0,1.21l1.86,1.73a1,1,0,0,0,1.15.36l1.09-.36a8.31,8.31,0,0,0,1.25,1.25l-.36,1.09a1,1,0,0,0,.36,1.15L12,22.43a1,1,0,0,0,1.21,0l1.86-1.86a1,1,0,0,0,.36-1.15l-.36-1.09a8.31,8.31,0,0,0,1.25-1.25l1.09.36a1,1,0,0,0,1.15-.36L20.43,14a1,1,0,0,0,0-1.21ZM12,15.5A3.5,3.5,0,1,1,15.5,12,3.5,3.5,0,0,1,12,15.5Z" /></svg>',
        'children' => [
                        ...
                        @elseif ($navItem['type'] === 'dropdown')
                            ...
                            <li>
                                <button @click="openNav = (openNav === '{{ $navItem['id'] }}' ? null : '{{ $navItem['id'] }}')"
                                    ...
                                    {{ $navItem['label'] }}
                                    <span class="ml-auto transition-transform duration-200" :class="{ 'rotate-90': openNav === '{{ $navItem['id'] }}' }">
