    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h3 class="text-gray-500 text-sm font-medium">Doanh số đơn hàng</h3>
                    <span class="text-2xl font-semibold text-gray-900 block mt-1">{{ number_format($totalOrderValue) }} VND</span>
                </div>
            </div>
        </div>
    </div>
                    ...
                    @forelse ($usages as $usage)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 font-medium text-green-600">
                                {{ number_format($usage->discount_amount) }} VND
                            </td>
                            <td class="px-6 py-4">
                                @if ($usage->order)
