...
@section('title', 'Chỉnh sửa Nhóm Thông số')
...
<div class="body-content px-4 sm:px-6 md:px-8 py-8">
    <div class="container mx-auto max-w-4xl"> {{-- Giới hạn chiều rộng cho form dễ nhìn hơn --}}
        ...
        {{-- PAGE HEADER --}}
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-800">Chỉnh sửa Nhóm Thông số</h1>
        ...
        {{-- FORM --}}
        <form action="{{ route('admin.specification-groups.update', $specificationGroup) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="card-custom-body">
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" class="form-input @error('name') is-invalid @enderror" value="{{ old('name', $specificationGroup->name) }}" required>
                            @error('name')
                        ...
                        <div>
                            ...
                            <input type="number" id="order" name="order" class="form-input @error('order') is-invalid @enderror" value="{{ old('order', $specificationGroup->order ?? 0) }}" style="width: 150px;">
