    ...
    <div class="w-full">
        <div class="flex items-center justify-between flex-wrap gap-4 mb-6">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('admin.sales-staff.work-shifts.index') }}"
            ...
            <div class="p-4 border-b border-gray-200 flex flex-wrap items-center justify-between gap-4">
                <div class="flex items-center gap-4 flex-wrap">
                    <select id="province-filter"
                        class="w-full sm:w-56 py-2 px-3 border border-gray-300 rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    ...
                    <div class="relative flex-grow">
                        <input id="store-search-input" type="text" placeholder="Tìm theo tên cửa hàng..."
                            class="pl-10 pr-4 py-2 border border-gray-300 rounded-lg w-full sm:w-64 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button id="add-staff-btn-global"
                        class="flex items-center gap-2 bg-indigo-600 text-white font-semibold px-4 py-2 rounded-lg hover:bg-indigo-700 transition-colors w-full sm:w-auto">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round">
                            <circle cx="12" cy="12" r="10"></circle>
                        ...
                        @forelse($stores ?? [] as $item)
                            <tr class="bg-white border-b hover:bg-gray-50">
                                <td class="px-6 py-4 font-medium text-gray-900">
                                    <a href="{{ route('admin.sales-staff.stores.employees', $item->id) }}"
                                ...
                                <td colspan="5" class="px-6 py-4 text-center text-gray-500">
                                    <div class="flex flex-col items-center py-8">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-12 w-12 text-gray-400"
                                            ...
                                            <path
                                                d="M2 20v-4a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2Z" />
                                            <path d="M12 14v-2" />
                                            <path d="M20 14h.01" />
                                            <path d="M4 14h.01" />
                                        </svg>
