            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            <input type="radio" id="shift-morning" name="work_shift_name" value="Ca Sáng" class="hidden peer">
                        ...
                        <div>
                            <input type="radio" id="shift-afternoon" name="work_shift_name" value="Ca Chiều" class="hidden peer">
                        ...
                        <div>
                            <input type="radio" id="shift-evening" name="work_shift_name" value="Ca Tối" class="hidden peer">
                        ...
                        <div>
                            <input type="radio" id="shift-off" name="work_shift_name" value="Nghỉ" class="hidden peer">
