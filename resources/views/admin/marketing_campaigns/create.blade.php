                            ...
                            <div class="space-y-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <textarea id="emailContent" name="emailContent" rows="12"
                                        class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition">Chào  Imart xin gửi tặng bạn ưu đãi đặc biệt...</textarea>
