...
<div class="max-w-screen-2xl mx-auto p-4 md:p-8">
    <header class="mb-8">
        <div class="flex items-center justify-between mb-4">
            <div>
                <nav aria-label="breadcrumb" class="mb-2">
                    <ol class="flex text-sm text-gray-500">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.shippers.index') }}" class="text-indigo-600 hover:text-indigo-800">Quản lý Nhân viên Giao hàng</a>
                        </li>
                        <li class="breadcrumb-item text-gray-400 mx-2">/</li>
                        <li class="breadcrumb-item active text-gray-700 font-medium" aria-current="page">{{ $warehouse->name }}</li>
                    </ol>
                </nav>
            ...
            <a href="{{ route('admin.shippers.create') }}" class="px-5 py-2.5 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 font-semibold flex items-center justify-center space-x-2">
            ...
            <form action="{{ route('admin.shippers.warehouse.show', $warehouse) }}" method="GET">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="flex items-end space-x-3">
                        ...
                        <a href="{{ route('admin.shippers.warehouse.show', $warehouse) }}" class="w-full px-5 py-2 bg-gray-200 text-gray-700 rounded-lg text-center font-semibold">Xóa lọc</a>
                    </div>
                </div>
            </form>
        </div>
