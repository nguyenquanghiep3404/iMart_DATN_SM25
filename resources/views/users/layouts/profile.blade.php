...
<head>
    ...
    <link rel="preload" href="{{ asset('assets/users/fonts/inter-variable-latin.woff2') }}" as="font"
        type="font/woff2" crossorigin="">

    <!-- Font icons -->
    <link rel="preload" href="{{ asset('assets/users/icons/cartzilla-icons.woff2') }}" as="font"
        type="font/woff2" crossorigin="">
