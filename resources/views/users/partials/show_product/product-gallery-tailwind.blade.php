<div class="image-gallery">
    ...
    <div class="relative flex items-center mt-4">
        ...
        <div id="main-thumbnails" class="flex overflow-x-auto gap-2 px-8 w-full">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Thumbnails scroll event
        if (thumbsPrevBtn && thumbsNextBtn && mainThumbnails) {
            thumbsPrevBtn.addEventListener('click', () => {
                mainThumbnails.scrollBy({ left: -100, behavior: 'smooth' });
            });
