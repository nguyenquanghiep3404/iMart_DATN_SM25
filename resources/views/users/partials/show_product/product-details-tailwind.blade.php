                    ...
                    <div class="border-b border-gray-200 py-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <div class="flex gap-2 mt-2"><img
                                        src="https://placehold.co/80x80/d0d0d0/333?text=Ảnh+thật" alt="Review Image"
                                        class="w-20 h-20 rounded-md object-cover"><img
                                ...
                                <div class="text-xs text-gray-500 mt-2 flex items-center gap-4"><span>2 ngày
                                        trước</span><button
                                        class="flex items-center gap-1 text-blue-600 hover:underline"><svg
