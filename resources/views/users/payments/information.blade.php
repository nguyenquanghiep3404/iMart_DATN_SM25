    ...
    <script>
        ...
        const CheckoutPage = {
            ...
            bindEvents() {
                ...
                if (this.elements.selectStoreBtn) this.elements.selectStoreBtn.addEventListener('click', () => this
            ...
            renderPickupOrderSummary() {
                ...
                this.state.cartItems.forEach(product => {
                    ...
                    productNode.querySelector('.product-name').textContent = product.name;
                    productNode.querySelector('.product-variant').textContent = product.variant;
                    productNode.querySelector('.product-price').textContent = this.helpers.formatCurrency(
                        product.price);
