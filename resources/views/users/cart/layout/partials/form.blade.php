<section class="bg-body-tertiary py-5">
    ...
    <div id="slide-alert" class="hidden">
      <span id="slide-alert-message">Thông báo</span>
      <button id="slide-alert-close" class="close-btn" aria-label="Đóng">&times;</button>
    </div>
    <div id="slide-alert" class="hidden fixed top-5 right-5 bg-red-500 text-white px-4 py-2 rounded shadow transition-transform duration-300 transform translate-x-full z-50">
        <span id="slide-alert-message">Thông báo</span>
