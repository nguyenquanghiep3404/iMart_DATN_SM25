...
@section('content')
      ...
      <section>
        <div class="position-relative">
          <span class="position-absolute top-0 start-0 w-100 h-100 rounded-0 d-none-dark rtl-flip" style="background: linear-gradient(90deg, #accbee 0%, #e7f0fd 100%)"></span>
          <span class="position-absolute top-0 start-0 w-100 h-100 rounded-0 d-none d-block-dark rtl-flip" style="background: linear-gradient(90deg, #1b273a 0%, #1f2632 100%)"></span>
                ...
                <div class="swiper-wrapper">
                      <div class="swiper-slide d-flex justify-content-end">
                        <div class="ratio rtl-flip" style="max-width: 495px; --cz-aspect-ratio: calc(537 / 495 * 100%)">
                          <img src="{{ asset ('assets/users/img/home/electronics/hero-slider/01.png') }}" alt="Image">
                        </div>
                      </div>
                      <div class="swiper-slide d-flex justify-content-end">
                        <div class="ratio rtl-flip" style="max-width: 495px; --cz-aspect-ratio: calc(537 / 495 * 100%)">
                          <img src="{{ asset ('assets/users/img/home/electronics/hero-slider/02.png') }}" alt="Image">
                        </div>
                      </div>
                      <div class="swiper-slide d-flex justify-content-end">
                        <div class="ratio rtl-flip" style="max-width: 495px; --cz-aspect-ratio: calc(537 / 495 * 100%)">
                          <img src="{{ asset ('assets/users/img/home/electronics/hero-slider/03.png') }}" alt="Image">
                        </div>
                      </div>
                    </div>
              </div>
      ...
      <section class="container pt-5 mt-1 mt-sm-2 mt-md-3 mt-lg-4">
        ...
        <div class="row">
          ...
          <div class="col-lg-4" data-bs-theme="dark">
            <div class="d-flex flex-column align-items-center justify-content-end h-100 text-center overflow-hidden rounded-5 px-4 px-lg-3 pt-4 pb-5" style="background: #1d2c41 url({{ asset ('assets/users/img/home/electronics/banner/background.jpg') }}) center/cover no-repeat">
          ...
          <div class="col-sm-6 col-lg-4 d-flex flex-column gap-3 pt-4 py-lg-4">
            ...
            <div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
              <div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
                <img src="{{ asset ('assets/users/img/shop/electronics/thumbs/01.png') }}" alt="Smart Watch">
              </div>
            ...
            <div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
              <div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
                <img src="{{ asset ('assets/users/img/shop/electronics/thumbs/03.png') }}" width="110" alt="VR Glasses">
              </div>
              <div class="w-100 min-w-0 ps-2 ps-sm-3">
                <div class="d-flex align-items-center gap-2 mb-2">
                  <div class="d-flex gap-1 fs-xs">
            ...
            <div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
              <div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
                <img src="{{ asset ('assets/users/img/shop/electronics/thumbs/05.png') }}" width="110" alt="Bluetooth Headphones">
              </div>
              <div class="w-100 min-w-0 ps-2 ps-sm-3">
                <div class="d-flex align-items-center gap-2 mb-2">
                  <div class="d-flex gap-1 fs-xs">
            ...
            <div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
              <div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
                <img src="{{ asset ('assets/users/img/shop/electronics/thumbs/07.png') }}" width="110" alt="MacBook">
              </div>
              <div class="w-100 min-w-0 ps-2 ps-sm-3">
                <div class="d-flex align-items-center gap-2 mb-2">
                  <div class="d-flex gap-1 fs-xs">
          ...
          <div class="col-sm-6 col-lg-4 d-flex flex-column gap-3 pt-3 py-lg-4">
            ...
            <div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
              <div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
                <img src="{{ asset ('assets/users/img/shop/electronics/thumbs/02.png') }}" width="110" alt="iPad Pro">
              </div>
              <div class="w-100 min-w-0 ps-2 ps-sm-3">
                <div class="d-flex align-items-center gap-2 mb-2">
                  <div class="d-flex gap-1 fs-xs">
            ...
            <div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
              <div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
                <img src="{{ asset ('assets/users/img/shop/electronics/thumbs/04.png') }}" width="110" alt="AirPods 2 Pro">
              </div>
              <div class="w-100 min-w-0 ps-2 ps-sm-3">
                <div class="d-flex align-items-center gap-2 mb-2">
                  <div class="d-flex gap-1 fs-xs">
            ...
            <div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
              <div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
                <img src="{{ asset ('assets/users/img/shop/electronics/thumbs/06.png') }}" width="110" alt="Power Bank">
              </div>
              <div class="w-100 min-w-0 ps-2 ps-sm-3">
                <div class="d-flex align-items-center gap-2 mb-2">
                  <div class="d-flex gap-1 fs-xs">
            ...
            <div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
              <div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
                <img src="{{ asset ('assets/users/img/shop/electronics/thumbs/08.png') }}" width="110" alt="iPhone 14">
              </div>
              <div class="w-100 min-w-0 ps-2 ps-sm-3">
                <div class="d-flex align-items-center gap-2 mb-2">
                  <div class="d-flex gap-1 fs-xs">
              ...
              <div class="position-relative">
                ...
                <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="shop-product-general-electronics.html">
                  ...
                  <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                    <img src="{{ asset ('assets/users/img/shop/electronics/01.png') }}" alt="VR Glasses">
                  </div>
                </a>
              </div>
          ...
          <div class="col">
            <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
              <div class="position-relative">
                ...
                <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="shop-product-general-electronics.html">
                  <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                    <img src="{{ asset ('assets/users/img/shop/electronics/02.png') }}" alt="iPhone 14">
                  </div>
                </a>
              </div>
              <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
          ...
          <div class="col">
            <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
              <div class="position-relative">
                ...
                <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="shop-product-general-electronics.html">
                  <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                    <img src="{{ asset ('assets/users/img/shop/electronics/03.png') }}" alt="Smart Watch">
                  </div>
                </a>
              </div>
              <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
            ...
            <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
              <div class="position-relative">
                ...
                <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="shop-product-general-electronics.html">
                  ...
                  <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                    <img src="{{ asset ('assets/users/img/shop/electronics/04.png') }}" alt="MacBook">
                  </div>
                </a>
              </div>
              <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
          ...
          <div class="col">
            <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
              <div class="posittion-relative">
                ...
                <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="shop-product-general-electronics.html">
                  <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                    <img src="{{ asset ('assets/users/img/shop/electronics/05.png') }}" alt="iPad Air">
                  </div>
                </a>
              </div>
              <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
          ...
          <div class="col">
            <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
              <div class="position-relative">
                ...
                <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="shop-product-general-electronics.html">
                  <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                    <img src="{{ asset ('assets/users/img/shop/electronics/06.png') }}" alt="AirPods 2">
                  </div>
                </a>
              </div>
              <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
          ...
          <div class="col">
            <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
              <div class="posittion-relative">
                ...
                <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="shop-product-general-electronics.html">
                  <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                    <img src="{{ asset ('assets/users/img/shop/electronics/07.png') }}" alt="iPad Pro">
                  </div>
                </a>
              </div>
              <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
          ...
          <div class="col">
            <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
              <div class="posittion-relative">
                ...
                <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="shop-product-general-electronics.html">
                  <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                    <img src="{{ asset ('assets/users/img/shop/electronics/08.png') }}" alt="Bluetooth Headphones">
                  </div>
                </a>
              </div>
              <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
            ...
            <div class="position-relative">
              ...
              <div class="row align-items-center position-relative z-2">
                ...
                <div class="col-md-6 d-flex justify-content-center justify-content-md-end pb-5 pb-md-0">
                  <div class="me-xxl-4">
                    <img src="{{ asset ('assets/users/img/home/electronics/banner/camera.png') }}" class="d-block rtl-flip" width="420" alt="Camera">
              ...
              <div class="swiper-slide">
                <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                  <div class="position-relative">
                    ...
                    <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="shop-product-general-electronics.html">
                      <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                        <img src="{{ asset ('assets/users/img/shop/electronics/09.png') }}" alt="Wireless Buds">
                      </div>
                    </a>
                  </div>
                  <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
              ...
              <div class="swiper-slide">
                <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                  <div class="position-relative">
                    ...
                    <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="shop-product-general-electronics.html">
                      <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                        <img src="{{ asset ('assets/users/img/shop/electronics/11.png') }}" alt="Nikon Camera">
                      </div>
                    </a>
                  </div>
                  <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
              ...
              <div class="swiper-slide">
                <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                  <div class="position-relative">
                    ...
                    <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="shop-product-general-electronics.html">
                      <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                        <img src="{{ asset ('assets/users/img/shop/electronics/10.png') }}" alt="iPhone 14">
                      </div>
                    </a>
                  </div>
                  <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
            ...
            <div class="col-md-6 col-lg-5 col-xl-4 offset-lg-1 offset-xl-2">
              <ul class="list-unstyled d-flex flex-column gap-4 ps-md-4 ps-lg-0 mb-3">
                <li class="nav flex-nowrap align-items-center position-relative">
                  <img src="{{ asset ('assets/users/img/home/electronics/vlog/01.jpg') }}" class="rounded" width="140" alt="Video cover">
                  <div class="ps-3">
                ...
                <li class="nav flex-nowrap align-items-center position-relative">
                  <img src="{{ asset ('assets/users/img/home/electronics/vlog/02.jpg') }}" class="rounded" width="140" alt="Video cover">
                  <div class="ps-3">
                ...
                <li class="nav flex-nowrap align-items-center position-relative">
                  <img src="{{ asset ('assets/users/img/home/electronics/vlog/03.jpg') }}" class="rounded" width="140" alt="Video cover">
                  <div class="ps-3">
...
<style>
    .hero-banner {
        margin-top: -16px; /* Adjust based on your header height */
    }
</style>
@endpush
