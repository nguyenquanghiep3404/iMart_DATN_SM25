                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide d-flex justify-content-end">
                            <div class="ratio rtl-flip" style="max-width: 495px; --cz-aspect-ratio: calc(537 / 495 * 100%)">
                                ...
                                <img src="{{ Storage::url($banner->desktopImage->path) }}" alt="{{ $banner->title }}">
                                @elseif($banner->mobileImage)
                                <img src="{{ Storage::url($banner->mobileImage->path) }}" alt="{{ $banner->title }}">
                                @else
...
<<<<<<< HEAD
    <style>
        .hero-banner {
         ...
         /* Nền toàn trang */
    section.container {
        background-color: #f8f9fb; /* Màu xám nhạt hơn trắng (#ffffff) */
        border-radius: 8px;
    }
    </style>
=======
