...
class CouponController extends Controller
{
    ...
    public function changeStatus(Coupon $coupon, $status)
    {
        ...
        // Kiểm tra nếu coupon đã hết hạn thì không cho phép thay đổi trạng thái
        if ($coupon->expired()) {
            return redirect()->back()->with('error', 'Mã giảm giá đã hết hạn, không thể thay đổi trạng thái.');
        }
